** Make sure docker is running and also it is switch to windows container
** It will take lot of time for the docker image to be created, so have some patience
